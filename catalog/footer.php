...
<script type="text/javascript">
 ...
 <script type="text/javascript">
      ...
      <script type="text/javascript">
          const current1 = document.getElementById("current_div");
          const divs = document.querySelectorAll(".description h5");
          divs.forEach(h5 => {
            h5.addEventListener("click", (e) => {
                divs.forEach(div => {
                    div.style.color = "rgba(0, 0, 0, 0.820)";
      ...
      <script type="text/javascript">
        ...
        desc.onclick = function(){
            ...
            document.querySelector('#char1').style.display = 'none';
        }
        chars.onclick = function(){
            document.querySelector('#char1').style.display = 'block';
